...
('Reliable Batteries to Keep You Moving', 'Premium Automotive Batteries', 'Fast & Reliable Car Battery Delivery & Installation in CDO, MisOr & Dito Areas | 24/7 Service | Dead Battery? We''re just a call away!', 'Shop All Batteries', '#', '#1E3A8A', '#FFFFFF', 1),
('24/7 Emergency Battery Service', 'Never Get Stranded Again', 'Our expert team is available round the clock to deliver and install batteries when you need them most. Fast, reliable, and professional service.', 'Call Now', 'tel:+639123456789', '#DC2626', '#FFFFFF', 2),
