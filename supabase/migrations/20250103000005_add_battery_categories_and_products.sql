-- Add battery categories and products migration
-- This migration first adds the required battery categories, then adds the products

-- First, add the battery categories
...
-- Note: effective_price is calculated dynamically in the application
-- No need to update it in the database as it's computed from base_price and discount_price
