...
('misor', 'Misamis Oriental', 'MisOr', false, '1-4 hours (Same Day)', 500, ARRAY['El Salvador', 'Opol', 'Tagoloan', 'Villanueva', 'Jasaan', 'Claveria', 'Balingasag', 'Binuangan', 'Manticao', 'Naawan', 'Libertad', 'Sugbongcogon']),
('dito', 'Dito Areas', 'Dito', false, '1-2 Days', 1000, ARRAY['Iligan City', 'Cagayan de Oro Outskirts', 'Bukidnon', 'Lanao del Norte', 'Camiguin', 'Lanao del Sur'])
